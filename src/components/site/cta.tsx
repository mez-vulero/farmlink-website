    ...
    >
      ...
      <div className="relative flex flex-col gap-6 text-center">
        <span className="mx-auto inline-flex items-center gap-2 rounded-full bg-white/80 px-4 py-2 text-xs font-medium uppercase tracking-[0.3em] text-accent">
          ...
          Let’s build your coffee operating system
        </span>
        ...
        <p className="mx-auto max-w-3xl text-pretty text-base text-muted-foreground">
          Share your growth goals and we’ll configure FarmLink for your workflows. Migrations, training, and change management included.
        </p>
        <div className="flex flex-col justify-center gap-3 sm:flex-row">
          <Button size="lg" className="rounded-full bg-accent px-8 text-accent-foreground hover:bg-accent/90" asChild>
            <Link href="mailto:hello@farmlink.app?subject=FarmLink%20demo%20request">
              Schedule a discovery call
              <ArrowRight className="ml-2 h-4 w-4" />
            </Link>
          </Button>
          <Button size="lg" variant="outline" className="rounded-full border-primary/40 text-primary hover:bg-primary/10" asChild>
